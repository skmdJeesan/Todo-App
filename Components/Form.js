  ...
  return (
    <>
      <form 
        ...
        className='flex items-center justify-center gap-7 mt-7 mb-5 text-white'
      >
        <input
          type='text' placeholder='Enter tasks here'
          className='py-3 px-6 bg-[#ffffff18] backdrop-blur-[2px] rounded-full shadow-2xl border-1 border-[#ffffff13]  w-100 text-xl'
          value={task}
